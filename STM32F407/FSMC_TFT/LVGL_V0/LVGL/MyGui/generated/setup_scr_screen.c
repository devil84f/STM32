...
void setup_scr_screen(lv_ui *ui)
{
	...
	lv_label_set_text(ui->screen_label_2, "20：41   July");
	lv_label_set_long_mode(ui->screen_label_2, LV_LABEL_LONG_WRAP);
	lv_obj_set_pos(ui->screen_label_2, 52, 122);
	lv_obj_set_size(ui->screen_label_2, 216, 36);
	...
	lv_label_set_text(ui->screen_label_6, "41°C");
	...
	lv_label_set_text(ui->screen_label_7, "45°C");
	...
	lv_label_set_text(ui->screen_label_8, "2025年7月15日");

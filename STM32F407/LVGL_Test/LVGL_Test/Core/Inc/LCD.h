...
//////////////////////////////////////////////////////////////////////////////////	 
//-----------------LCD端口定义---------------- 
#define LCD_LED_STATE() HAL_GPIO_ReadPin(GPIOD, GPIO_PIN_12)
#define LCD_LED_ON()    HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_SET)
#define LCD_LED_OFF()   HAL_GPIO_WritePin(GPIOD, GPIO_PIN_12, GPIO_PIN_RESET)
#define LCD_LED_TOGGLE() HAL_GPIO_TogglePin(GPIOD, GPIO_PIN_12)  		//LCD背光      
//LCD地址结构体
typedef struct
{
	u16 LCD_REG;
